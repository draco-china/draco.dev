/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/navigation/wrangler.jsonc apps/navigation/worker-configuration.d.ts` (hash: 6d0a16d97ae0507e82f502b856d10b6d)
...
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./server/entry.cloudflare");
	}
